...
<div class="mb-6">
	...
	>
		<a
			...
			class="absolute -top-3 left-4 bg-gray-100 dark:preset-filled-surface-500 px-2 anchor text-sm font-medium rounded-md border border-primary-200 shadow-sm"
			>D 8.1</a
		>
		<div class="mt-2">
			<span class="content"
		...
		<div class="mt-2">
			<span class="content"
				>Der kuͦnec <span class="tei-name"
					><span data-ref="regp:p0107"><span class="tei-hi1 red rot">G</span>ramoflanz</span></span
				> in bot</span
			>
		</div>
	</div>
